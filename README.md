...
push to `master` and every pull request targeting `master`. CI currently tests
Python 3.11 and 3.14; 3.11 remains the compatibility baseline while 3.14 is
being validated as the latest stable target. It uses placeholder configuration
values only; no production secrets are required.
